...
const EditCompany = () => {
  ...
  return (
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-900">
      <div className="bg-gray-800 shadow-lg rounded-lg p-6 w-11/12 md:w-2/3 lg:w-1/2">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="bg-blue-500 hover:bg-blue-600 mb-4 px-2 py-1 text-white rounded-md"
          >
            Close
          </button>
        </div>
        <form onSubmit={handleSubmit}>
          <label className="block mb-2 text-white">
            ...
            <input
              ...
              required
              className="mt-1 p-2 border border-gray-600 rounded w-full bg-gray-700 text-white focus:outline-none"
            />
          </label>
          ...
          <fieldset className="mb-4">
            <legend className="font-semibold text-white">Emails:</legend>
            {company.emails.map((email, index) => (
              <div key={index} className="flex items-center mb-2">
                <input
                  ...
                  className="p-2 border border-gray-600 rounded w-full bg-gray-700 text-white focus:outline-none"
                />
          ...
          <fieldset className="mb-4">
            <legend className="font-semibold text-white">Phone Numbers:</legend>
