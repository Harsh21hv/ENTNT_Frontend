    ...
    <div className="p-6 ">
      <div className="overflow-x-auto rounded-lg shadow-md border border-gray-200">
        <table className="min-w-full table-auto border-collapse">
          <thead className="bg-[#202936] border-b text-white">
            <tr>
          ...
          <tbody>
            {dashboardData
              ...
              .map((company) => (
                ...
                >
                  <td className="px-6 py-4 text-base text-white font-medium">
                    {company.companyName}
                  </td>
                    ...
                    <ul className="flex flex-col gap-1">
                      {company.lastFiveCommunications.map((comm, index) => (
                        <li
                          key={index}
                          title={comm.notes || ""}
                          className="relative group bg-[#202936] pl-2 rounded shadow border-2 mb-1 "
                        >
