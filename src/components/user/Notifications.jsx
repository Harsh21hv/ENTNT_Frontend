...
const Notifications = () => {
  ...
  return (
    <div className="h-screen bg-[#202936]">
      <nav className="flex justify-between items-center bg-gray-950 text-white px-6 py-4 shadow-md">
        <h2 className="text-xl font-semibold">Notifications</h2>
        <div className="flex items-center space-x-4">
          <Link to="/user">
            <button className="bg-gray-800 text-white py-2 px-4 text-2xl rounded-md hover:bg-gray-100 transition duration-200 shadow">
              <FaHome />
            </button>
          </Link>
          <Link to="/calendar">
            <button className="bg-gray-800 text-white font-medium py-2 px-4 rounded-md hover:bg-gray-100 transition duration-200 shadow">
              Open Calendar
            </button>
          </Link>
        </div>
      ...
      <div className="p-6 bg-[#202936]">
        ...
        <section className="mb-8">
          ...
          {notifications.overdue.length > 0 ? (
            ...
            <p className="text-white">No overdue communications.</p>
          )}
        </section>
        ...
        <section>
          ...
          {notifications.today.length > 0 ? (
            ...
            <p className="text-white">No communications due today.</p>
          )}
        </section>
      </div>
    </div>
