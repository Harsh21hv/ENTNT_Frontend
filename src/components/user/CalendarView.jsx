...
const CalendarView = () => {
  ...
  return (
    <div className="calendar-container flex flex-col items-center p-4 bg-[#202936] text-white">
      <div className="flex items-center justify-between w-full mb-16 mt-16 ">
        ...
        <button
          ...
          className="bg-blue-500 text-xl text-white py-1 px-3 rounded-md hover:bg-blue-600 "
        >
          Close
        </button>
      </div>
      ...
      <div className="w-full flex items-center justify-around space-x-10">
        <div className={`w-4/5 bg-white text-black rounded-md`} id="calendar">
          <Calendar
            localizer={localizer}
            events={events}
            startAccessor="start"
