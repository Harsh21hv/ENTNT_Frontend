...
const Login = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black'>
      <div className='relative w-full max-w-md bg-[#202936] px-10 pb-10 pt-5 shadow-lg rounded-lg border border-gray-300 '>
        <h2 className='text-2xl font-bold text-white text-center mt-5 mb-6'>
          Login !
        </h2>
        {error && (
